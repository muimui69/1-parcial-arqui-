...
//            val pdfFilePath = cliente?.let { it1 ->
//                PDFGenerator.generarPDFRutina(holder.itemView.context,
//                    it1, rutina)
//            }
//
//            if (pdfFilePath != null) {
...
//            val pdfFilePath = PDFGenerator.generarPDFRutina(holder.itemView.context, cliente!!, rutina)
